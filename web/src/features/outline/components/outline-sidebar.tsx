...
export function OutlineSidebar({ bookId, selectedSceneId, onSelectScene }: OutlineSidebarProps) {
  ...
  const creationError = sectionMutation.isError || chapterMutation.isError || sceneMutation.isError;
      ...
      {creationError ? (
        <div className="border-t border-zinc-200 p-3">
          <FeedbackMessage variant="error">
            Não foi possível criar o item agora. Verifique a API e tente novamente.
          </FeedbackMessage>
        </div>
      ) : null}
    </aside>
