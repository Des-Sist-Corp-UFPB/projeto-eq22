    ...
    void v20BackfillsLegacyManuscriptAndEnforcesTenantConstraints() throws Exception {
        ...
        try {
            ...
            try (Connection connection = dataSource.getConnection()) {
                ...
                assertSqlState(connection, schema, "23503", "insert into books (id, tenant_id, title, status, created_at, updated_at) values ('10000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000099', 'Invalid tenant', 'PLANNING', current_timestamp, current_timestamp)");
